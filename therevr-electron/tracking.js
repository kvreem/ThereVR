...
(function() {
  ...
  tracking.ColorTracker.prototype.getNeighboursForWidth_ = function(width) {
    ...
    neighbours[0] = -width * 3;
    neighbours[1] = -width * 3 + 3;
    neighbours[2] = 3;
    neighbours[3] = width * 3 + 3;
    neighbours[4] = width * 3;
    neighbours[5] = width * 3 - 3;
    neighbours[6] = -3;
    neighbours[7] = -width * 3 - 3;
  ...
  tracking.ColorTracker.prototype.trackColor_ = function(pixels, width, height, color) {
    ...
    // var currGroup = new Int32Array((pixels.length + (pixels.length/3)) >> 2);
    ...
    for (var i = 0; i < height; i++) {
      for (var j = 0; j < width; j++) {
        ...
        while (queuePosition >= 0) {
          ...
          if (colorFn(pixels[currW], pixels[currW + 1], pixels[currW + 2], currW, currI, currJ)) {
