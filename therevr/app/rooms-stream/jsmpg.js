...
var jsmpeg = function(canvas) {
	// var opts = opts || {};
	var opts = { progressiveThrottled: true };
...
jsmpeg.prototype.receiveSocketMessage = function(messageData) {

	// var messageData = new Uint8Array(event.data);
	// console.log(messageData.chunk);
	// var messageData = new Uint8Array(messageData.chunk);
	...
	// messageData = messageData.subarray(2);
